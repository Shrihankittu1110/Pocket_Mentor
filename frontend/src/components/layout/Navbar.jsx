      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 h-16 flex items-center justify-between">
        ...
        {isAuthenticated && user ? (
          <div className="flex items-center gap-2 sm:gap-4">
            ...
            <Link
              to="/progress"
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-2xl bg-amber-50 border border-amber-200 hover:bg-amber-100 transition shadow-sm group"
              title="Daily Streak"
            >
            ...
            <div
              className="flex items-center gap-1.5 px-3 py-1.5 rounded-2xl bg-blue-50 border border-blue-200 shadow-sm"
              title="Total XP Points"
            >
              <Star className="w-4 h-4 text-mentor-blue fill-mentor-blue" />
            ...
            <button
              ...
              className={`p-2 rounded-xl border transition ${
                soundEnabled
                  ? 'bg-emerald-50 border-emerald-200 text-mentor-green hover:bg-emerald-100'
            ...
            <div className="relative">
              <button
                ...
                className="flex items-center gap-2 p-1 rounded-full hover:ring-2 hover:ring-emerald-300 transition"
              >
                <img
          ...
          <div className="flex items-center gap-3">
            <Link
              to="/login"
              className="px-4 py-2 text-sm font-bold text-slate-700 hover:text-mentor-green transition"
            >
              Sign In
            </Link>
            <Link
              to="/register"
              className="px-4 py-2 text-sm font-bold rounded-xl btn-duo-green"
            >
              Get Started Free
            </Link>
          </div>
